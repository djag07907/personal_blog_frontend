...
export const mockArticles: Article[] = [
  ...
  {
    id: 2,
    title: "Getting Started with Strapi as a Headless CMS",
    description:
      "Use Strapi to manage content in your Next.js applications efficiently.",
  ...
  {
    id: 3,
    title: "Dark Mode Toggle in Tailwind + Next.js",
    description: "Implement dark/light theme toggling in a modern Next.js app.",
  ...
  {
    id: 4,
    title: "Understanding Agile for Developers",
    description:
      "Agile development made simple for frontend and full-stack devs.",

...
const SimpleContactPage = () => {
  const contactData = {
    ...
    content:
      "I'm always eager to connect with fellow developers, potential collaborators, and anyone interested in discussing technology, projects, or opportunities.",
    address: "Remote / Available Worldwide",
    socialLinks: {
      linkedin: "https://www.linkedin.com/in/djag-dev/",
      github: "https://github.com/djag07907",
      instagram: "https://www.instagram.com/dalvarez1ng/",
    },
  };
